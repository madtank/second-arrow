<!-- source: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost | fetched: 2026-07-02 | mirror of NousResearch/hermes-agent@30e947e0 website/docs/user-guide/messaging/mattermost.md -->
---
sidebar_position: 8
title: "Mattermost"
