<!-- source: https://hermes-agent.nousresearch.com/docs/user-guide/multi-profile-gateways | fetched: 2026-07-02 | mirror of NousResearch/hermes-agent@30e947e0 website/docs/user-guide/multi-profile-gateways.md -->
---
sidebar_position: 4
---
