<!-- source: https://hermes-agent.nousresearch.com/docs/user-guide/features/mixture-of-agents | fetched: 2026-07-02 | mirror of NousResearch/hermes-agent@30e947e0 website/docs/user-guide/features/mixture-of-agents.md -->
---
sidebar_position: 7
