<!-- source: https://hermes-agent.nousresearch.com/docs/developer-guide/image-gen-provider-plugin | fetched: 2026-07-02 | mirror of NousResearch/hermes-agent@30e947e0 website/docs/developer-guide/image-gen-provider-plugin.md -->
---
sidebar_position: 11
