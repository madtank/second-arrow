<!-- source: https://hermes-agent.nousresearch.com/docs/developer-guide/memory-provider-plugin | fetched: 2026-07-02 | mirror of NousResearch/hermes-agent@30e947e0 website/docs/developer-guide/memory-provider-plugin.md -->
---
sidebar_position: 8
