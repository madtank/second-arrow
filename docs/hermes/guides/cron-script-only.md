<!-- source: https://hermes-agent.nousresearch.com/docs/guides/cron-script-only | fetched: 2026-07-02 | mirror of NousResearch/hermes-agent@30e947e0 website/docs/guides/cron-script-only.md -->
---
sidebar_position: 13
