<!-- source: https://hermes-agent.nousresearch.com/docs/reference/profile-commands | fetched: 2026-07-02 | mirror of NousResearch/hermes-agent@30e947e0 website/docs/reference/profile-commands.md -->
---
sidebar_position: 7
---
