<!-- source: https://hermes-agent.nousresearch.com/docs/reference/mcp-config-reference | fetched: 2026-07-02 | mirror of NousResearch/hermes-agent@30e947e0 website/docs/reference/mcp-config-reference.md -->
---
sidebar_position: 8
