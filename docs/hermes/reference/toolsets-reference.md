<!-- source: https://hermes-agent.nousresearch.com/docs/reference/toolsets-reference | fetched: 2026-07-02 | mirror of NousResearch/hermes-agent@30e947e0 website/docs/reference/toolsets-reference.md -->
---
sidebar_position: 4
