<!-- source: https://hermes-agent.nousresearch.com/docs/reference/skills-catalog | fetched: 2026-07-02 | mirror of NousResearch/hermes-agent@30e947e0 website/docs/reference/skills-catalog.md -->
---
sidebar_position: 5
