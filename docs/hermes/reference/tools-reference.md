<!-- source: https://hermes-agent.nousresearch.com/docs/reference/tools-reference | fetched: 2026-07-02 | mirror of NousResearch/hermes-agent@30e947e0 website/docs/reference/tools-reference.md -->
---
sidebar_position: 3
