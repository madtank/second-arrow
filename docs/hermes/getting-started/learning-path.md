<!-- source: https://hermes-agent.nousresearch.com/docs/getting-started/learning-path | fetched: 2026-07-02 | mirror of NousResearch/hermes-agent@30e947e0 website/docs/getting-started/learning-path.md -->
---
sidebar_position: 3
title: 'Learning Path'
